...
{                                                             
		...
		//	AFIO_Init                                             
		GPIO_EXTILineConfig(INT_EXTIPort, INT_EXTIPin);          
		//	EXTI_Init                                             
		EXTI_InitTypeDef EXTI_InitStructure;                      
		EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;       
		EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Falling;   
		EXTI_InitStructure.EXTI_LineCmd = ENABLE;                 
		EXTI_InitStructure.EXTI_Line = INT_EXTILine;              
		...
		NVIC_InitStructure.NVIC_IRQChannel = INT_NVICIRQ;         
...
{
		if(EXTI_GetITStatus(INT_EXTILine) == SET){
				EXTI_ClearITPendingBit(INT_EXTILine);
				Control();
		}
}
